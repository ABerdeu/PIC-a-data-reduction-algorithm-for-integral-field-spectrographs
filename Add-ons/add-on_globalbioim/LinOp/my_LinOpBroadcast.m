classdef my_LinOpBroadcast <  LinOp
    ...
    %
    % **Example** S=my_LinOpBroadcast(sz,index)
    %
    % See also :class:`LinOp`, :class:`Map`
    
    %%    Copyright (C) 2018
    %     F. Soulez ferreol.soulez@epfl.ch
    %     Modified: 10/15/2018 (mm/dd/yyyy)
    ...
    %% Constructor
    methods
        function this = my_LinOpBroadcast(sz,index)
            if nargin == 1
                index = [];
            end
            this.name ='my_LinOpBroadcast ';

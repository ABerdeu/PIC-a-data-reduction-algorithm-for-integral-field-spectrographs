classdef my_CostL1 < Cost
    % my_CostL1: L1 norm cost function
    % $$C(x) := \\|\\mathrm{x}\\|_1 $$
    % 
    % :param sz: size of the input
    %
    % :param flag_constraint: flag for the flag_input (can be a matric of
    ...
    %
    % **Example** C=my_CostL1(sz)
    %
    % **Example** C=my_CostL1(sz, flag_constraint)
    %
    % **Example** C=my_CostL1(sz, flag_constraint, W)
    %
    ...
    methods
        function this = my_CostL1(sz, flag_constraint, W)
            this.name='my_CostL1';
            this.isConvex=true;
            ...
            elseif isempty(flag_constraint)
                ...
                flag_constraint = sign(flag_constraint) ;
            end
